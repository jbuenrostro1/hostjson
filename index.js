...
// Return Spider-Man as JSON.
var spiderMan = {
	"firstName":"Peter",
	"lastName":"Parker",
	"preferredName":"Spider-man",
	"email":"spider-man@lewisu.edu",
	"phoneNumber":"800-777-mann",
	"city":"Gotham",
	"state":"NJ",
	"zip":"07101",
	"lat":"40.73",
...
var JazminBuenrostro = {
	"firstName":"Jazmin",
	"lastName":"Buenrostro",
	"email":"jazminmbuenrostro@lewisu.edu",
	"city":"Plainfield",
	"state":"IL",
	"zip":"60586",
...
app.get('/personal', (request, response) => {
	...
	response.type('application/json')
	response.send(JSON.stringify(JazminBuenrostro, null, 4))
})
